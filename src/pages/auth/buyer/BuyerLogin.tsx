...
import { User, ArrowRight, Building2, Lock, Mail, AlertCircle } from 'lucide-react';
...
export default function BuyerLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // 4. DIRECT IMMEDIATE NAVIGATION to Buyer Dashboard
    setLoading(false);
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-bold text-white tracking-tight">Buyer Portal Login</h2>
        ...
        <div className="pt-2 text-center text-xs text-slate-400 border-t border-slate-800 flex justify-between">
          <Link to="/auth/buyer/register" className="hover:text-emerald-400">
